...
const Home = () => {
  ...
  const [tagAuthor, setTagAuthor] = useState<string>('');
            ...
            <View style={styles.rightComment}>
              ...
              <View style={styles.boxComment}>
                <BaseText
                  ...
                  color="#303030"
                  fontWeight={'400'}>
                  Tôi cảm thấy tôi viết còn hay hơn tác giả này ấy. Đầu voi đuôi
                  chuột dễ sợ. Đọc tới đây thì muốn bỏ luôn, ko đọc nữa cho đỡ
                  tốn thời gian. Demo 3 dòng...{' '}
                  <BaseText
                    size={12}
                    lineHeight={14}
                    color="#528AFF"
